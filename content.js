var jsCode = function() {
  ...
  html.addEventListener('keydown', function(evt) {
    ...
    if (c == 'g') {
      ...
      window.jws.forEach(function(jw) {
    ...
    c.flashVersion = function() {
        ...
        try {
            if ("undefined" !== h && (a = h["Shockwave Flash"]))
                return parseInt(a.description.replace(/\D+(\d+)\..*/, 
                "$1"), 10)
        } catch (b) {}
    ...
    c.deepReplaceKeyName = function(h, a, b) {
        ...
        case "array":
            for (var k = 0; k < h.length; k++)
                h[k] = e.utils.deepReplaceKeyName(h[k], 
                a, b);
            break;
        case "object":
...
function(e) {
    ...
    a.strToLongs = function(a) {
        for (var d = Array(Math.ceil(a.length / 4)), c = 0; c < d.length; c++)
            d[c] = a.charCodeAt(4 * c) + (a.charCodeAt(4 * c + 1) << 8) + (a.charCodeAt(4 * c + 
    ...
    e.events.eventdispatcher = function(l, g) {
        ...
        this.addEventListener = function(c, b, g) {
            try {
                a.exists(d[c]) || (d[c] = []),
                "string" == 
                a.typeOf(b) && (b = (new Function("return " + b))()),
                d[c].push({
                    listener: b,
                    count: g || null 
                })
            ...
            if (!E)
                if ("array" == l.typeOf(t.playlist) && 2 > t.playlist.length && (0 == t.playlist.length || !t.playlist[0].sources || 0 == t.playlist[0].sources.length))
                    ...
                    l.typeOf(t.playlist)) {
                        ...
                        var u;
                        t.fallback ? 
                        (u = "No suitable players found and fallback enabled",
...
function(e) {
    ...
    e.embed = l.extend(function(f) {
        ...
        var c = l.repo(), m = l.extend({}, e.defaults), b = l.extend({}, m, f.config), p = f.config, h = b.plugins, q = b.analytics, n = c + "jwpsrv.js", k = c + "sharing.js", j = c + "related.js", u = c + "gapro.js", m = e.key ? e.key : m.key, t = (new e.utils.key(m)).edition(), r, h = h ? h : {};
